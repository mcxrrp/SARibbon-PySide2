...
from PySide2.QtCore import Qt, QSize, Signal, QObject, QEvent, QRect, QPoint, QMargins
from PySide2.QtGui import QIcon, QPainter, QColor, QResizeEvent, QMouseEvent, QPen, QHoverEvent, QCursor
from PySide2.QtWidgets import QMenuBar, QAbstractButton, QApplication, QAction, QFrame, QStyle
...
class SARibbonBar(QMenuBar):
    ...
    # 信号
    applitionButtonClicked = Signal()       # 应用按钮点击响应 - 左上角的按钮，通过关联此信号触发应用按钮点击的效果
    currentRibbonTabChanged = Signal(int)   # 标签页变化触发的信号
